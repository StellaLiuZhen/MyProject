...
public class CKFinderConfig extends Configuration {
    ...
    protected Configuration createConfigurationInstance() {
		...
		boolean isView = true;//utils.getSubject().isPermitted("cms:ckfinder:view");
		boolean isUpload = true;//utils.getSubject().isPermitted("cms:ckfinder:upload");
		boolean isEdit = true;//utils.getSubject().isPermitted("cms:ckfinder:edit");
...
//		}
		...
		try {
//			WPrincipal principal = (WPrincipal)SecurityUtils.getSubject().getPrincipal();
